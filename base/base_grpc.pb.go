...
func (c *streamClient) Conversations(ctx context.Context, opts ...grpc.CallOption) (Stream_ConversationsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Stream_ServiceDesc.Streams[0], "/base.Stream/Conversations", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamConversationsClient) Send(m *Packet) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamConversationsClient) Recv() (*Packet, error) {
	m := new(Packet)
...
func (x *streamConversationsServer) Send(m *Packet) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamConversationsServer) Recv() (*Packet, error) {
	m := new(Packet)
